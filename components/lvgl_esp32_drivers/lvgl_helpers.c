...
void lvgl_driver_init(void) {
  ...
  ESP_LOGI(TAG, "Display hor size: %d, ver size: %d", LV_HOR_RES_MAX,
           LV_VER_RES_MAX);
#endif
  ...
  lvgl_spi_driver_init(TFT_SPI_HOST, TP_SPI_MISO, DISP_SPI_MOSI, DISP_SPI_CLK,
